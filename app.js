...
async function startOrder(accountId) {
  ...
  document.getElementById('buy-btn').textContent = 'Уншиж байна...';
  ...
  if (data.error) {
    ...
    document.getElementById('buy-btn').textContent = '⚡ Худалдаж авах';
    return;
  }

  // Show QR
  document.getElementById('buy-btn').style.display = 'none';
  document.getElementById('order-area').innerHTML = qrHtml(data);
