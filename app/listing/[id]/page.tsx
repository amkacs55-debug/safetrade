          ...
          <div className="bg-dark-900 border border-dark-800 rounded-2xl p-6">
            ...
            <div className="mt-4 p-3 bg-dark-800 rounded-xl text-xs text-dark-400 space-y-1">
              <div className="flex justify-between">
                <span>Үнэ:</span><span className="text-white">{formatPrice(listing.price)}</span>
              </div>
              <div className="flex justify-between">
                <span>Шимтгэл (5%):</span><span className="text-red-400">-{formatPrice(commission)}</span>
              </div>
              <div className="flex justify-between border-t border-dark-700 pt-1">
                <span>Худалдагч авах:</span><span className="text-green-400 font-medium">{formatPrice(sellerReceives)}</span>
              </div>
            </div>
          </div>
            ...
            <div className="bg-dark-900 border border-dark-800 rounded-2xl p-6">
              ...
              {listing.seller.is_verified_seller && (
                <div className="mt-3 flex items-center gap-2 bg-brand-500/10 border border-brand-500/20 rounded-xl px-3 py-2 text-xs text-brand-300">
                  <Shield size={12} /> Баталгаажсан худалдагч
                </div>
              )}
            </div>
          )}
